    ...
    >
      <div class="contain">
        <el-form ref="form" :model="form" :rules="rules" label-width="150px">
          ...
          <el-row>
            <el-form-item label="监控提醒上涨幅度(%)" prop="monitorIncreasePer" required>
              <el-input-number
                v-model="form.monitorIncreasePer"
                type="input"
                placeholder="输入幅度(%)"
                :precision="2"
              ></el-input-number>
          ...
          <el-row>
            <el-form-item label="监控提醒下跌幅度(%)" prop="monitorDecreasePer" required>
              <el-input-number
                v-model="form.monitorDecreasePer"
                type="input"
                placeholder="输入幅度(%)"
                :precision="2"
              ></el-input-number>
          ...
          <el-row>
            <el-form-item label="上涨卖出幅度(%)" prop="tradeIncreasePer" required>
              <el-input-number
                v-model="form.tradeIncreasePer"
                type="input"
                placeholder="输入幅度(%)"
                :precision="2"
              ></el-input-number>
          ...
          <el-row>
            <el-form-item label="下跌买入幅度(%)" prop="tradeDecreasePer" required>
              <el-input-number
                v-model="form.tradeDecreasePer"
                type="input"
                placeholder="输入幅度(%)"
                :precision="2"
              ></el-input-number>
...
import { savePlan, startPlan, stopPlan, deletePlan, getPlanList } from "@/api/dayplan";
  ...
  data() {
    return {
      ...
      form: {
        ...
        moniterIncreasePer: undefined,
        moniterDecreasePer: undefined,

        tradeIncreasePer: undefined,
        tradeDecreasePer: undefined,
  ...
  methods: {
    ...
    handleTrade(data) {
      ...
      this.form = {
        ...
        tradeStockNum: 500,
        // lockStockNum: 100,
        monitorIncreasePer: 1.00,
        monitorDecreasePer: 1.00,
        tradeIncreasePer: 1.20,
        tradeDecreasePer: 1.20,
      };
